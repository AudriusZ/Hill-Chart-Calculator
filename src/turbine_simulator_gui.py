...
class Ui_OutputOptionsHydraulic(object):
    def setupUi(self, OutputOptionsHydraulic):
        ...
        OutputOptionsHydraulic.resize(251, 421)
        font = QtGui.QFont()
        font.setPointSize(11)
        OutputOptionsHydraulic.setFont(font)
        self.pushButton = QtWidgets.QPushButton(parent=OutputOptionsHydraulic)
        self.pushButton.setGeometry(QtCore.QRect(20, 20, 201, 381))
        self.pushButton.setObjectName("pushButton")
    ...
    def retranslateUi(self, OutputOptionsHydraulic):
        ...
        self.pushButton.setText(_translate("OutputOptionsHydraulic", "Apply"))
